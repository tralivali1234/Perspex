...
namespace Perspex.Styling
{
    ...
    /// control (such as <see cref="StyleSelectors.OfType{T}(StyleSelector)"/>) and ones whose result can 
    /// change over time (such as <see cref="StyleSelectors.Class(StyleSelector, string)"/>. For the first
